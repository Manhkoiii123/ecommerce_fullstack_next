...
type PendingApprovalUIProps = {
  stores: Store[];
  currentStore: Store;
  storeUrl: string;
};

export const PendingApprovalUI = ({
  stores,
  currentStore,
  storeUrl,
}: PendingApprovalUIProps) => {
  return (
    <div className="h-full w-full flex">
      <Sidebar stores={stores} />
      <div className="w-full ml-[340px]">
        <Header storeUrl={storeUrl} />
            ...
            <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
              <div className="mb-6">
                ...
                <p className="text-gray-600 mb-4">
                  Your store &quot;{currentStore.name}&quot; is currently under
                  review.
                </p>
              </div>
